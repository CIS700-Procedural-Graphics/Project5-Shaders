...
export default function(renderer, scene, camera) {
    ...
    const Shader = {
        initGUI: function(gui) {
            ...
            gui.add(options, 'numSteps').onChange(function(val) {
                Shader.material.uniforms.u_numSteps.value = val;
            });
            gui.add(options, 'doEdge').onChange(function(val) {
                Shader.material.uniforms.u_doEdge.value = val;
            });
